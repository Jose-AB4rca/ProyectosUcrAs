...
<div class="conatiner-fluid min-vh-100 d-flex justify-content-center bg-image" 
    ...
    <div class="row col-sm-10 bg-primary mb-5 mt-4 h-50">
        <form action="<?php echo constant('URL');?>tematicas/agregarTematica" method="post" style="text-align: center;">
           <h1 class="mt-3" style="color: white;">Agregar tematica</h1>
           <div class="row">
                <div class="col-sm-12">
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <textarea type="text" maxlength="100" class="form-control" id="Descripcion" name="Descripcion" rows="4" cols="40" required></textarea>
                    </div> 
                </div>
           </div>
           <div class="d-flex justify-content-end">
           <button style="background-color: white;" type="submit" class="btn mt-4 mb-5">Crear</button>
           <a style="background-color: white; margin-left: 1rem;" href="<?php echo constant('URL').'tematicas/listaEspecifica/'.$this->id;?>" type="button" class="btn mt-4 mb-5">Volver</a>
           </div>  
        </form> 
    </div>
</div>
