...
<div class="conatiner-fluid min-vh-100 d-flex justify-content-center bg-image" 
    ...
    <div class="row col-sm-10 bg-primary mb-5 mt-4 h-50">
        <form action="<?php echo constant('URL').'anotaciones/agregarAnotacion';?>" method="post" style="text-align: center;">
           <h1 class="mt-3" style="color: white;">Crear una anotación</h1>
           <div class="row justify-content-center">
                <div class="col-sm-6">
                    ...
                    <div class="mb-3">
                        <input type="number" class="form-control" id="IdAnotacion" name="IdAnotacion" value="" readonly hidden>
                    </div>
                    <div class="mb-3">
           ...
           <button style="background-color: white;" type="submit" class="btn mt-4 mb-5">Agregar anotación</button>
