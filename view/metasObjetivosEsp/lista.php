    ...
    <section class="min-vh-100 h-100 bg-image" style="background-image: url('img/p14.jpg');">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>  
                            ...
                            <a name="del" id="del" onclick="deletefina('<?php echo $ob->idObjetivoEsp;?>','<?php echo $ob->idMeta;?>')" class="btn btn-danger m-1"  role="button">eliminar</a>
                        </td>
                    </tr>
                <?php      
                    }
        ...
        <script>
              function deletefina(idp,ido) {
                const data = [idp,ido];
                if (confirm("Deseas borrar la meta: ".concat(data[1]).concat(" ?"))) {
                    location.href = "<?php echo constant('URL').'metasObjetivosEsp/borrarMetasObjetivosEsp/';?>".concat(data);
                }
            }
        </script>
        </script>
