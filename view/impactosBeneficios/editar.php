...
<div class="conatiner-fluid min-vh-100 d-flex justify-content-center bg-image" 
    ...
    <div class="row col-sm-10 bg-primary mb-5 mt-4 h-50">
        <form action="<?php echo constant('URL').'impactosBeneficios/editarImpactoB';?>" method="post" style="text-align: center;">
           <h1 class="mt-3" style="color: white;">Editar los impactos y beneficios</h1>
           <div class="row justify-content-center"> 
                <div class="col-sm-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="IdImpacto" name="IdImpacto" value="<?php echo $this->item->idImpacto;?>" readonly>
                    </div>
                    <div class="mb-3">
                ...
                <div class="col-sm-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="Poblacion" name="Poblacion" maxlength="100" value="<?php echo $this->item->poblacion;?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="pwd" style="color: white;" class="form-label mt-2">Beneficio a la población:</label>
                        <textarea class= "form-control" id="BeneficioPoblacion" name="BeneficioPoblacion" rows="4" cols="40" required><?php echo $this->item->beneficioPoblacion;?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="pwd" style="color: white;" class="form-label mt-2">Beneficio a la Ucr:</label>
                        <textarea class= "form-control" id="BeneficioUcr" name="BeneficioUcr" rows="4" cols="40" required><?php echo $this->item->beneficioUcr;?></textarea>
                    </div>
                </div>
           </div>
