        ...
        <div class="container min-vh-100 h-100 bg-light" id="admin-cards">
            ...
            <table class="table display dt-responsive nowrap" id="table_id">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td><?php echo $ob->idProyecto." - ".$ob->idCronograma;?></td>
                        <td><?php echo $ob->tipo;?></td>
                        <td><?php echo $ob->actividad;?></td>
                        <td><?php echo $ob->fechaInicio." - ".$ob->fechaFin;?></td>
                        <td><?php echo $ob->descripcion;?></td>
                        <td>  
                            <a name="editar" id="editar" class="btn btn-warning m-1" href="<?php echo constant('URL').'cronogramas/editar/'.$ob->idProyecto.'?idc='.$ob->idCronograma?>" role="button">editar</a>
                            <a name="del" id="del" onclick="deleteCon('<?php echo $ob->idProyecto;?>','<?php echo $ob->idCronograma;?>')" class="btn btn-danger m-1"  role="button">eliminar</a>
                        </td>
                    </tr>
                <?php      
                    }
