...
<div class="conatiner-fluid min-vh-100 d-flex justify-content-center bg-image" 
    ...
    <div class="row col-sm-10 bg-primary mb-5 mt-4 h-50">
        <form action="<?php echo constant('URL').'convenios/agregarConvenio';?>" method="post" style="text-align: center;">
           <h1 class="mt-3" style="color: white;">Añadir convenio</h1>
           <div class="row justify-content-center">
                <div class="col-sm-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="IdConvenio" name="IdConvenio" placeholder="automatico" required readonly>
                    </div>
                    <div class="mb-3">
           ...
           <button style="background-color: white;" type="submit" class="btn mt-4 mb-5">Agregar convenio</button>
