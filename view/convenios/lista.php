...
<body>
    ...
    <section class="min-vh-100 h-100 bg-image" style="background-image: url('img/p14.jpg');">
        <div class="container min-vh-100 h-100 bg-light" id="admin-cards">
            <br>
            <h2 class="text-center mb-3">Convenios del proyecto</h2>
            ...
            <table class="table display dt-responsive nowrap" id="table_id">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $ob->idConvenio;?></td>
                        <td><?php echo $ob->convenios;?></td>
                        <td>  
                            <a name="editar" id="editar" class="btn btn-warning m-1" href="<?php echo constant('URL').'convenios/editar/'.$ob->idProyecto.'?idc='.$ob->idConvenio?>" role="button">editar</a>
                            <a name="del" id="del" onclick="deleteConv('<?php echo $ob->idProyecto;?>','<?php echo $ob->idConvenio;?>')" class="btn btn-danger m-1"  role="button">eliminar</a>
                        </td>
                    </tr>
                <?php      
                    }
