...
<div class="conatiner-fluid min-vh-100 d-flex justify-content-center bg-image" 
    ...
    <div class="row col-sm-10 bg-primary mb-5 mt-4 h-50">
        <form action="<?php echo constant('URL').'convenios/editarConvenio';?>" method="post" style="text-align: center;">
           <h1 class="mt-3" style="color: white;">Editar convenio</h1>
           <div class="row justify-content-center">
                <div class="col-sm-6">
                    ...
                    <div class="mb-3">
                        <label for="pwd" style="color: white;" class="form-label mt-2">ID de convenio:</label>
                        <input type="text" class="form-control" id="IdConvenio" name="IdConvenio" value="<?php echo $this->item->idConvenio;?>" required readonly>
                    </div>
                    <div class="mb-3">
