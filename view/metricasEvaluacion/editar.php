...
<div class="conatiner-fluid min-vh-100 d-flex justify-content-center bg-image" 
    ...
    <div class="row col-sm-10 bg-primary mb-5 mt-4 h-50">
        <form action="<?php echo constant('URL').'metricasEvaluacion/editarMetricaEva';?>" method="post" style="text-align: center;">
           <h1 class="mt-3" style="color: white;">Editar metrica de evaluación</h1>
           <div class="row justify-content-center"> 
                <div class="col-sm-6">
                    ...
                    <div class="mb-3">
                        <label for="pwd" style="color: white;" class="form-label mt-2">ID metrica:</label>
                        <input type="number" class="form-control" id="IdMetrica" name="IdMetrica" value="<?php echo $this->item->idMetrica;?>" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="pwd" style="color: white;" class="form-label mt-2">Evaluación proyecto:</label>
                        <textarea class= "form-control" id="EvaluacionProyeecto" name="EvaluacionProyecto" rows="4" cols="40" required><?php echo $this->item->evaluacionProyecto;?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="pwd" style="color: white;" class="form-label mt-2">Evaluacion impacto:</label>
                        <textarea class= "form-control" id="EvaluacionImpacto" name="EvaluacionImpacto" rows="4" cols="40" required><?php echo $this->item->evaluacionImpacto;?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="pwd" style="color: white;" class="form-label mt-2">Evaluacion participantes:</label>
                        <textarea class= "form-control" id="EvaluacionParticipante" name="EvaluacionParticipante" rows="4" cols="40" required><?php echo $this->item->evaluacionParticipante;?></textarea>
                    </div>
                </div>
           </div>
