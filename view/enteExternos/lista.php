...
<body>
    ...
    <section class="min-vh-100 h-100 bg-image" style="background-image: url('img/p14.jpg');">
        <div class="container min-vh-100 h-100 bg-light" id="admin-cards">
            <br>
            <h2 class="text-center mb-3">Entes externos relacionados del proyecto</h2>
            ...
            <table class="table display dt-responsive nowrap" id="table_id">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $ob->idEnteExterno;?></td>
                        <td><?php echo $ob->ente;?></td>
                        <td><?php echo $ob->tipo;?></td>
                        <td>  
                            <a name="editar" id="editar" class="btn btn-warning m-1" href="<?php echo constant('URL').'enteExternos/editar/'.$ob->idProyecto.'?idc='.$ob->idEnteExterno?>" role="button">editar</a>
                            <a name="del" id="del" onclick="deleteEnte('<?php echo $ob->idProyecto;?>','<?php echo $ob->idEnteExterno;?>')" class="btn btn-danger m-1"  role="button">eliminar</a>
                        </td>
                    </tr>
                <?php      
                    }
        ...
        <script>
              function deleteEnte(idp,ido) {
                const data = [idp,ido];
                if (confirm("Deseas borrar el ente externo: ".concat(data[1]).concat(" ?"))) {
                    location.href = "<?php echo constant('URL').'enteExternos/borrarEnteExt/';?>".concat(data);
                }
            }
        </script>
        </script>
