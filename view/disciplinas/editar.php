...
<div class="conatiner-fluid min-vh-100 d-flex justify-content-center bg-image" 
    ...
    <div class="row col-sm-10 bg-primary mb-5 mt-4 h-50">
        <form action="<?php echo constant('URL').'disciplinas/editarDisciplina';?>" method="post" style="text-align: center;">
           <h1 class="mt-3" style="color: white;">Editar disciplina</h1>
           <div class="row justify-content-center">
                <div class="col-sm-6">
                    ...
                    <div class="mb-3">
                        <label for="pwd" style="color: white;" class="form-label mt-2">ID disciplina:</label>
                        <input type="number" class="form-control" id="IdDisciplina" name="IdDisciplina" value="<?php echo $this->item->idDisciplina;?>" required readonly>
                    </div>
                    <div class="mb-3">
                        <label for="pwd" style="color: white;" class="form-label mt-2">Disciplina:</label>
                        <textarea class= "form-control" id="Disciplina" name="Disciplina" rows="4" cols="40" required><?php echo $this->item->disciplina;?></textarea>
                    </div>   
                </div>
           </div>
