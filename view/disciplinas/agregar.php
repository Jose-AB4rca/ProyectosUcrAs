...
<div class="conatiner-fluid min-vh-100 d-flex justify-content-center bg-image" 
    ...
    <div class="row col-sm-10 bg-primary mb-5 mt-4 h-50">
        <form action="<?php echo constant('URL').'disciplinas/agregarDisciplina';?>" method="post" style="text-align: center;">
           <h1 class="mt-3" style="color: white;">Añadir disciplina</h1>
           <div class="row justify-content-center">
                <div class="col-sm-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="IdDisciplina" name="IdDisciplina" placeholder="auto" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="pwd" style="color: white;" class="form-label mt-2">Disciplina:</label>
                        <textarea class= "form-control" id="Disciplina" name="Disciplina" rows="4" cols="40" required></textarea>
                    </div>   
                </div>
           </div>
