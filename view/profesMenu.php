  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo constant('URL');?>vistas/proyectos">Proyectos</a>
        </li>
        <li class="nav-item">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a type="button" class="btn btn-secondary" href="<?php echo constant('URL').'usuarios/editar/'.$_SESSION['cedula'];?>">Editar mi usuario</a>
              </div>
            </div>
          </div>
        </div>
