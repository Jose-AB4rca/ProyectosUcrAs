...
<div class="conatiner-fluid min-vh-100 d-flex justify-content-center bg-image" 
    ...
    <div class="row col-sm-10 bg-primary mb-5 mt-4 h-50">
        <form action="<?php echo constant('URL');?>proyectos/editarProyecto" method="post" style="text-align: center;">
           <h1 class="mt-3" style="color: white;">Editar proyecto ID <?php echo $this->item->idProyecto;?></h1>
           <div class="row">
                <div class="col-sm-6">
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" id="Justificacion" class= "form-control" name="Justificacion" rows="4" cols="40" required><?php echo $this->item->justificacion;?></textarea> 
                    </div>                  
                    <div class="mb-3">
                        <label for="Metodologia" style="color: white;">Metodologia</label>
                        <textarea type="text" id="Metodologia" class= "form-control" name="Metodologia" rows="3" cols="40" required><?php echo $this->item->metodologia;?></textarea> 
                    </div>
                    <div class="mb-3">
                        <label for="FechaInicio" style="color: white;"> fecha de inicio</label>
                        <input type="date" class="form-control" name="FechaInicio" id="FechaInicio" value="<?php echo $this->item->fechaInicio; ?>" required>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <textarea type="text" id="Antecedentes" class= "form-control" name="Antecedentes" rows="4" cols="40" required><?php echo $this->item->antecedentes;?></textarea> 
                    </div>
                    <div class="mb-3">
                        <label for="Observaciones" style="color: white;">Observaciones</label>
                        <textarea type="text" id="Observaciones" class= "form-control" name="Observaciones" rows="4" cols="40" required><?php echo $this->item->observaciones;?></textarea> 
                    </div>
                    <div class="mb-3">
                        <label for="SubActividadesSubstantivas" style="color: white;">Sub-actividades Substantivas</label>
                        <textarea type="text" id="SubActividadesSubstantivas" class= "form-control" name="SubActividadesSubstantivas" rows="3" cols="40" required><?php echo $this->item->subActividadesSubstantivas;?></textarea> 
                    </div>
                    <div class="mb-3">
                        <label for="FechaFin" style="color: white;"> fecha de finalización</label>
                        <input type="date" class="form-control" name="FechaFin" id="FechaFin" value="<?php echo $this->item->fechaFin; ?>" required>
                    </div>
                    <div class="mb-3">
