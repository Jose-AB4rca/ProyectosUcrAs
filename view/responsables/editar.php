...
<div class="conatiner-fluid min-vh-100 d-flex justify-content-center bg-image" 
    ...
    <div class="row col-sm-10 bg-primary mb-5 mt-4 h-50">
        <form action="<?php echo constant('URL');?>responsables/editarResponsable" method="post" style="text-align: center;">
           <h1 class="mt-3" style="color: white;">Agregar responsable</h1>
           <div class="row">
                <div class="col-sm-12">
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="number" class="form-control" id="IdResponsable" name="IdResponsable" value="<?php echo $this->item->idResponsable?>" readonly>
                    </div> 
                    <div class="mb-3 mt-3">
                        <label for="Titulo" style="color: white;" class="form-label mt-2">Responsable:</label>
                        <textarea type="text" maxlength="100" class="form-control" id="Responsable" name="Responsable" rows="4" cols="40" required><?php echo $this->item->responsable?></textarea>
                    </div> 
                </div>
           </div>
           <div class="d-flex justify-content-end">
           <button style="background-color: white;" type="submit" class="btn mt-4 mb-5">editar</button>
           <a style="background-color: white; margin-left: 1rem;" href="<?php echo constant('URL').'responsables/listaEspecifica/'.$this->id;?>" type="button" class="btn mt-4 mb-5">Volver</a>
           </div>  
        </form> 
    </div>
</div>
