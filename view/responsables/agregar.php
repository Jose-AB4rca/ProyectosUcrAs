...
<div class="conatiner-fluid min-vh-100 d-flex justify-content-center bg-image" 
    ...
    <div class="row col-sm-10 bg-primary mb-5 mt-4 h-50">
        <form action="<?php echo constant('URL');?>responsables/agregarResponsable" method="post" style="text-align: center;">
           ...
           <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <textarea type="text" maxlength="100" class="form-control" id="Responsable" name="Responsable" rows="4" cols="40" required></textarea>
                    </div> 
                </div>
           </div>
