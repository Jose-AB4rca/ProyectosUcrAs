        ...
        <div class="container min-vh-100 h-100 bg-light" id="admin-cards">
            ...
            <table class="table display dt-responsive" id="table_id">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td><?php echo $ob->idProyecto." - ".$ob->idModalidad;?></td>
                        <td class="text-break"><div><?php echo $ob->descripcion;?></div></td>
                        <td>  
                            <a name="editar" id="editar" class="btn btn-warning m-1" href="<?php echo constant('URL').'modalidades/editar/'.$ob->idProyecto.'?idc='.$ob->idModalidad?>" role="button">editar</a>
                            <a name="del" id="del" onclick="deletefina('<?php echo $ob->idProyecto;?>','<?php echo $ob->idModalidad;?>')" class="btn btn-danger m-1"  role="button">eliminar</a>
                        </td>
                    </tr>
                <?php      
                    }
