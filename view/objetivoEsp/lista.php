    ...
    <section class="min-vh-100 h-100 bg-image" style="background-image: url('img/p14.jpg');">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>  
                            ...
                            <div>
                                <a name="enc" id="enc" class="btn btn-success m-1" href="<?php echo constant('URL').'metasObjetivosEsp/agregar/'.$ob->idObjetivoEsp?>" role="button">+ Metas</a>
                                <a name="enc" id="enc" class="btn btn-success m-1" href="<?php echo constant('URL').'metasObjetivosEsp/listaEspecifica/'.$ob->idObjetivoEsp?>" role="button">Ver metas</a>
                            </div>
                        </td>
                    </tr>
                <?php      
        ...
        <script>
              function deleteObs(idp,ido) {
                const data = [idp,ido];
                if (confirm("Deseas borrar la anotación: ".concat(data[1]).concat(" ?"))) {
                    location.href = "<?php echo constant('URL').'objetivosEspecificos/eliminarObjetivoEsp/';?>".concat(data);
                }
            }
        </script>
        </script>
